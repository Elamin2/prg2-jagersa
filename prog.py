...
#metod för att mata in ett värde mellan 1 och 6 och ett namn

def input_clamp (stat_name) dddddddddddddddddddddddddddddd
    return 0

    stats_ok = False
    while stats_ok is Flase:
...
def create_computer_horse():
    ...
    name_parts = ["ai", "tech", "lord", "evil", "clanker",
                  "pony", "horse", "oat", "elvis", "cyber", "steed", "musk"]
    horse = {
